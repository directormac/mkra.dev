...
pubDatetime: 2023-07-12T00:00:00Z
ogImage: ./cover.png
tags:
  - docker
  - server
...
1. A new popup below will show you what `IPv4 Method` you want to use press `enter`, you are in this section
   so select `Manual`
...
1. Install and run docker named pgadmin, replace `mac@mkra.dev` and `somethingsecret` with your email and desired password
...
1. Additional optins on portainer settings we could have done it on the commands above but
